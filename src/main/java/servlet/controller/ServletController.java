...
public class ServletController {
   ...
   public Map<String, Object> bjdTest(@RequestParam(name="sgg", required = false, defaultValue = "" ) String sgg) {
   ...
   public Map<String, Object> legend(@RequestParam("legend") String legend) {
       ...
       System.out.println("출력 화면" + response);
       return response;
   }
	
    @RequestMapping(value="/test.do")
    public String testPage() {
        return "main/test"; // test.jsp 파일을 찾아서 반환
    }
}
